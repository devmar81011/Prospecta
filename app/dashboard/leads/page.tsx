              ...
              {leads.map((lead) => (
                <div key={lead.id} className="bg-white rounded-lg shadow-sm border p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="mb-3 pb-3 border-b border-gray-100">
                    ...
                    <p className="text-sm text-gray-900">{lead.property_title}</p>
                    {lead.message && (
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      ...
                      className="w-full px-3 py-1.5 pr-8 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white"
                      style={{
